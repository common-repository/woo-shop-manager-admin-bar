...
function sma_adminbar_array() {
	...
	if ( class_exists( 'WooCommerce' ) || class_exists( 'Woocommerce' ) ) {
		...
		$menu_items[ 'wp-setting' ] = array(				
			...
			if ( is_plugin_active( 'customer-email-verification-for-woocommerce/customer-email-verification-for-woocommerce.php' ) || is_plugin_active( 'customer-email-verification-pro/customer-email-verification-pro.php' ) ) {
